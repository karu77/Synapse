...
const Tooltip = ({ visible, content, x, y }) => {
  ...
  return (
    ...
    >
      <div className="bg-gray-900/70 dark:bg-gray-800/70 backdrop-blur-md text-white rounded-lg shadow-2xl border border-gray-700/40 dark:border-gray-600/40 p-3 max-w-xs animate-tooltip-fade-in">
        <div 
        ...
        <div className="absolute top-full left-1/2 transform -translate-x-1/2">
          <div className="w-0 h-0 border-l-[6px] border-r-[6px] border-t-[6px] border-l-transparent border-r-transparent border-t-gray-900/70 dark:border-t-gray-800/70"></div>
        </div>
      </div>
    </div>
  )
